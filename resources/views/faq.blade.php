...
<link rel='stylesheet' id='elementor-post-991-css' href="{{ public_asset('css/post-991.css?ver=1733918323') }}" media='all' />
                    ...
                    <div class="swiper-wrapper">
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/gallery-1-min.jpeg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/gallery-1-min-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpeg') }}" title="gallery-1-min" alt="gallery-1-min" loading="lazy" />            </div>
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/gallery-2-min-scaled.jpeg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/gallery-2-min-scaled-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpeg') }}" title="gallery-2-min" alt="gallery-2-min" loading="lazy" />            </div>
                                                    <i class="insul-icon-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/gallery-3-min-scaled.jpeg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/gallery-3-min-scaled-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpeg') }}" title="gallery-3-min" alt="gallery-3-min" loading="lazy" />            </div>
                                                    <i class="insul-icon-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/brc-1-scaled.jpg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/brc-1-scaled-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpg') }}" title="brc-1" alt="brc-1" loading="lazy" />            </div>
                                                    <i class="insul-icon-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/gallery-5-min.jpeg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/gallery-5-min-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpeg') }}" title="gallery-5-min" alt="gallery-5-min" loading="lazy" />            </div>
                                                    <i class="insul-icon-plus"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="item-inner">
                                    <div class="slider-image_item image_item_1">
                                        <a href="{{ public_asset('wp-content/uploads/2024/04/gallery-6-min.jpeg') }}">
                                                        <div class="elementor-sliderimage-image-1">
                <img decoding="async" src="{{ public_asset('wp-content/uploads/elementor/thumbs/gallery-6-min-qwmlvh5v0scurkxa5uqez9jvwp5ahh1zxhmilmnjy0.jpeg') }}" title="gallery-6-min" alt="gallery-6-min" loading="lazy" />            </div>
                                                    <i class="insul-icon-plus"></i>
                                        </a>
                                    </div>
                                </div>
